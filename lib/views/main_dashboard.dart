...
class _MainDashBoardState extends State<MainDashBoard> {
  ...
  final menuItems = <String>[
    AppAssets.menuItemHome,
    AppAssets.menuItemAbout,
    AppAssets.menuItemServices,
    AppAssets.menuItemPortfolio,
    AppAssets.menuItemContact,
  ];
          ...
          builder: (context, constraints) {
            if (constraints.maxWidth < 768) {
              return Row(
                ...
                children: [
                  Text(AppAssets.menuItemPortfolio),
                  const Spacer(),
                  PopupMenuButton(
                    icon: Icon(
                      Icons.menu_sharp,
