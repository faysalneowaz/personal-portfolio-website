...
class _MyServicesState extends State<MyServices> {
      ...
      mobile: Column(
        ...
        children: [
          ...
          InkWell(
            ...
            child: buildAnimatedContainer(
              title: AppAssets.graphicdesignTitle,
          ...
          InkWell(
            ...
            child: buildAnimatedContainer(
              title: AppAssets.digitalmarketingTitle,
  ...
  FadeInDown buildMyServicesText() {
    return FadeInDown(
      ...
      child: RichText(
        text: TextSpan(
          text: AppAssets.serviceSpan1,
          style: AppTextStyles.headingStyles(fontSize: 30.0),
          children: [
            TextSpan(
              text: AppAssets.serviceSpan2,
    ...
    return AnimatedContainer(
      ...
      child: Column(
        children: [
          ...
          Text(
            AppAssets.service1shortDesc,
            style: AppTextStyles.normalStyle(fontSize: 14.0),
            textAlign: TextAlign.center,
          ),
          Constants.sizedBox(height: 20.0),
          AppButtons.buildMaterialButton(
              buttonName: AppAssets.readMoretext, onTap: () {})
        ],
      ),
    );
  }
