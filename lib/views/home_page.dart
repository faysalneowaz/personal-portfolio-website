      ...
      children: [
            ...
            children: [
              ...
              AnimatedTextKit(
                animatedTexts: [
                  TyperAnimatedText(
                    size.width < 768
                        ? AppAssets.homepageSpan1mobile
                        : AppAssets.homepageSpan1,
                    textStyle:
                        AppTextStyles.montserratStyle(color: Colors.lightBlue),
                  ),
                  TyperAnimatedText(AppAssets.homepageSpan2,
                      textStyle: AppTextStyles.montserratStyle(
                          color: Colors.lightBlue)),
                  TyperAnimatedText(AppAssets.homepageSpan3,
                      textStyle: AppTextStyles.montserratStyle(
                          color: Colors.lightBlue))
                ],
        ...
        FadeInUp(
          ...
          child: AppButtons.buildMaterialButton(
              onTap: () {}, buttonName: AppAssets.homepageDownloadCv),
        ),
      ],
    );
  }
